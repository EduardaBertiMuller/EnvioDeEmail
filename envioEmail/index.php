...
?>
<main> 
    <h1 id="info">Informática:</h1>
        <section id="home"> 
           
            <div id="figs">
                <div class="imagem">
                <img src="<?php echo URL_IMAGENS?>/img1.png">
                </div>
                <div class="imagem">
                    <img src="<?php echo URL_IMAGENS?>/img2.png" />
                </div>
                <div class="imagem">
                    <img  id="imgTres"src="<?php echo URL_IMAGENS?>/img3.png" />
                </div>
                <div class="imagem">
                    <img id="imgQuatro" src="<?php echo URL_IMAGENS?>/img4.png" />
                </div>
